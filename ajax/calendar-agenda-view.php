...
else
{
    ...
    while($startDay + 7 > $queryDay)
    {
        ...
        $q = "Select * from Appointments where (day <= ".date_format($qDateTime,"d")." and (day + num_of_days) >= ".date_format($qDateTime,"d").") and month = '".date_format($qDateTime,"m")."' and year = '".date_format($qDateTime,"Y")."' and (privacy = 0 or privacy = 1 or creator_id = ".$_SESSION['id'].")";
